...
public class InitDb {
  ...
  static class InitService {
    ...
    public void dbInit1() {
      Member member = createMember("userA", "toronto", "1", "1111", "canada", "ontario");
      em.persist(member);
    ...
    public void dbInit2() {
      Member member = createMember("userB", "New York", "2", "2222", "USA", "NY");
      em.persist(member);
    ...
    private Member createMember(String username, String city, String street,
      ...
      member.setAddress(new Address(street, country, province, city, zipcode));
      return member;
    }
